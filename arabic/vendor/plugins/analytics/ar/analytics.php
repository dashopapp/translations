...
return [
    ...
    'visits' => 'visits',
    'views' => 'views',
    'view_id_not_specified' => 'You must provide a valid view id. The document here: <a href="https://docs.dashopapp.com/cms/:version/plugin-analytics" target="_blank">https://docs.dashopapp.com/cms/:version/plugin-analytics</a>',
    'credential_is_not_valid' => 'Analytics credentials is not valid. The document here: <a href="https://docs.dashopapp.com/cms/:version/plugin-analytics" target="_blank">https://docs.dashopapp.com/cms/:version/plugin-analytics</a>',
